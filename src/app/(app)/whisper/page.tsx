      ...
      <div className="max-w-[1400px] mx-auto px-8 md:px-16 py-12 lg:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            {!keysActive ? (
               <div className="p-10 rounded-[3rem] bg-surface-container-low border border-outline-variant/10 editorial-shadow text-center space-y-6">
                  ...
                  <h3 className="font-serif text-2xl text-primary italic">Atelier Configuration Required</h3>
